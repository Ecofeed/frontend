...
import com.cndittpdev.ecofeed.ml.AutoModel1
...
class ScanActivity : AppCompatActivity() {
    ...
    fun pindahActivity() {
        ...
        belanja.setOnClickListener {
            Intent(this@ScanActivity, BelanjaActivity::class.java).also {
                startActivity(it)
            }
        }
        ...
        scan.setOnClickListener {
            Intent(this@ScanActivity, ScanActivity::class.java).also {
                startActivity(it)
            }
        }
        ...
        coin.setOnClickListener {
            Intent(this@ScanActivity, CoinActivity::class.java).also {
                startActivity(it)
            }
        }
        ...
        profile.setOnClickListener {
            Intent(this@ScanActivity, ProfileActivity::class.java).also {
                startActivity(it)
            }
        }
    }
